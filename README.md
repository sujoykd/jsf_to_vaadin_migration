...
For the exact, copy-pasteable commands see **[MIGRATION.md](migration/MIGRATION.md)**. This file is the
...
The original README of the web-budget application is retained here **[README.md](WEB_BUDGET_README.md)**.