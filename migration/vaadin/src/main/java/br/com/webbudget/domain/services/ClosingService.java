...
public class ClosingService {
    ...
    private final PeriodMovementCalculator periodMovementCalculator;
    private final List<ReopenPeriodLogic> reopenPeriodLogics;
    private final List<ClosingSavingLogic> closingSavingLogics;
