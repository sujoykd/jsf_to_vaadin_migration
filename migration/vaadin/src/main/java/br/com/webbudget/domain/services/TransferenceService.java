...
public class TransferenceService {
    ...
    private final List<TransferenceSavingLogic> savingBusinessLogics;
    ...
    public void transfer(Transference transference) {
        ...
        // transfer
        this.eventPublisher.publishEvent(new WalletBalanceUpdatedEvent(WalletBalanceBuilder.getInstance()
