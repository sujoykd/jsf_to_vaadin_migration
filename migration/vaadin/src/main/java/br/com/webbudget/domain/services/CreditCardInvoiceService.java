...
public class CreditCardInvoiceService {
     ...
     *
     * @param event the event containing the {@link FinancialPeriod} to create the {@link CreditCardInvoice}
     */
    @Transactional
    @EventListener
    public void createInvoices(FinancialPeriodOpenedEvent event) {
        FinancialPeriod financialPeriod = event.financialPeriod();
     ...
     *
     * @param event the event containing the {@link Card} we will open the {@link CreditCardInvoice}
     */
    @Transactional
    @EventListener
    public void createInvoices(CardCreatedEvent event) {
    ...
    /**
     * This method listen to events about the {@link Payment} of any {@link PeriodMovement} and if we are
     * paying a {@link CreditCardInvoice} movement, then, this method will update the status of the invoice
     *
     * @param event the event containing the {@link PeriodMovement} to check if is a invoice payment
     */
    @Transactional
    @EventListener
    public void changeInvoiceStatus(PeriodMovementPaidEvent event) {
        PeriodMovement periodMovement = event.periodMovement();
    ...
    /**
     * This method listen to events about the {@link Payment} of any {@link PeriodMovement} and if we are paying
     * with a credit {@link Card} update the {@link CreditCardInvoice} with this {@link PeriodMovement}
     *
     * @param event the event containing the {@link PeriodMovement} to be linked with the {@link CreditCardInvoice}
     * if the {@link Payment} are made with a credit {@link Card}
     */
    @Transactional
    @EventListener
    public void updateInvoiceAfterPayment(PeriodMovementPaidEvent event) {
        PeriodMovement periodMovement = event.periodMovement();
    ...
    /**
     * Listen for events about the action of deleting a {@link PeriodMovement} and then update the total value
     * of the {@link CreditCardInvoice}
     *
     * @param event the event containing the {@link PeriodMovement} to be discounted from the {@link CreditCardInvoice}
     */
    @Transactional
    @EventListener
    public void updateInvoiceAfterDelete(PeriodMovementDeletedEvent event) {
        PeriodMovement periodMovement = event.periodMovement();
     ...
     *
     * @param event the event containing the {@link PeriodMovement} data to update the {@link CreditCardInvoice}
     */
    @Transactional
    @EventListener
    public void updateInvoiceAfterPeriodMovementUpdate(PeriodMovementUpdatedEvent event) {
        PeriodMovement periodMovement = event.periodMovement();
