...
/**
 * Immutable entity representing a database view with with resume of consume for every card grouped by {@link CostCenter}
 * and {@link MovementClass}
 *
...
@Table(name = "wb_view_007", schema = FINANCIAL)
public class CardConsumeDetailed extends ImmutableEntity {
