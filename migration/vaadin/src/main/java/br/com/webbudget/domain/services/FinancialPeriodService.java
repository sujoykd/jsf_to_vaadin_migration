...
public class FinancialPeriodService {
    ...
    private final List<PeriodSavingLogic> savingBusinessLogics;
    private final List<PeriodDeletingLogic> periodDeletingLogics;
    ...
    public void save(FinancialPeriod financialPeriod) {
        ...
        this.eventPublisher.publishEvent(new FinancialPeriodOpenedEvent(
