...
public class FixedMovementService {
    ...
    private final List<FixedMovementSavingLogic> fixedMovementSavingLogics;
    private final List<FixedMovementDeletingLogic> fixedMovementDeletingLogics;
     ...
     *
     * @param event the event containing the opened {@link FinancialPeriod}
     */
    @EventListener
    public void onFinancialPeriodOpen(FinancialPeriodOpenedEvent event) {
