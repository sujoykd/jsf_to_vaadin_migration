...
/**
 * Immutable entity representing a database view with a quick resume of the values for every {@link CostCenter} on the
 * actual open (or expired) {@link FinancialPeriod}
 *
...
@Table(name = "wb_view_001", schema = FINANCIAL)
