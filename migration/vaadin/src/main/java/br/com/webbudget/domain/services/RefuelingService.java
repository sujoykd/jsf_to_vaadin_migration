...
public class RefuelingService {
     ...
     *
     * @param event the event containing the {@link PeriodMovement} to be deleted
     */
    @Transactional
    @EventListener
    public void removeRefuelingLinkWithPeriodMovement(PeriodMovementDeletedEvent event) {
