...
public class WalletService {
    ...
    private final List<WalletSavingLogic> savingBusinessLogics;
    private final List<WalletUpdatingLogic> updatingBusinessLogics;
    ...
    public void save(Wallet wallet) {
        ...
        this.updateWalletBalance(new WalletBalanceUpdatedEvent(builder.build()));
    }
     ...
     *
     * @param event the event with the balance historic
     */
    @Transactional
    @EventListener
    public void updateWalletBalance(WalletBalanceUpdatedEvent event) {
        WalletBalance walletBalance = event.walletBalance();
