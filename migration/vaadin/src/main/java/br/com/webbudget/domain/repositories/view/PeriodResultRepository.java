...
public interface PeriodResultRepository extends org.springframework.data.jpa.repository.JpaRepository<PeriodResult, Long> {
     ...
     */
    List<PeriodResult> findTop6ByOrderByIdDesc();
